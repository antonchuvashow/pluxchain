...
- **`config.py`**: Конфигурация проекта, включая настройки сложности, адреса и т.д.
...
#### `POST /blocks/mine`
Запускает процесс майнинга нового блока на узле. В блок будут включены все ожидающие транзакции.
